...
const Header = () => {
  return (
    <header className='page-header bg-primary text-white relative z-1'>
                ...
                <div className="flex items-center justify-between">
                    <nav>
                        <ul className='flex gap-10'>
                            ...
                            <li><Link href="#" className='uppercase text-xl hover:text-secondary transition-colors'>Menu</Link></li>
                            <li><Link href="#" className='uppercase text-xl hover:text-secondary transition-colors'>Contact</Link></li>
                        </ul>
                    </nav>
