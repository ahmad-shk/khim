        ...
        <div className='home-banner relative overflow-hidden'>
            ...
            <div className='caption'>
                <div className='container'>
                    ...
                    <h1 className='text-5xl xl:text-7xl 2xl:text-[118px] text-white italic leading-none' >KHIM <br /> ASIAN RESTAURANT</h1>
                    <Link href="#" className='mt-8 2xl:mt-20 inline-block'>
